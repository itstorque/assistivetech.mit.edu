<div style="margin: 0; background-color: var(--colorDarker); -webkit-transform:translate3d(0,0,0); min-height: 0px; height: auto; padding-left: 10vw; overflow-x: hidden;">
  ...
  <div style="width: 40vw; display: inline-block; vertical-align: top; margin-top: 40px" class="fixFooterOnSmall">
    ...
    <h3 style="margin-bottom: 40px">Quick Links</h3>

    <a class="link" href="gallery">Photo Gallery</a>

    <a class="linkAlt" href="https://giving.mit.edu/search/node/2530097" target="_blank">Donate</a>
    ...
    <div style="width: 40vw; display: inline-block; vertical-align: top; margin-top: 40px" class="fixFooterOnSmall">
      ...
      <div style="display: block">
        <img src="/resources/icons/email.svg" style="width: 35px; margin-bottom: -4px;">
      ...
      <div style="display: block">
      <img src="/resources/icons/fb.svg" style="width: 35px; margin-bottom: -4px;">
        <div style="display: inline-block">
      ...
      <div style="display: block">
        <img src="/resources/icons/twitter.png" style="width: 35px; margin-bottom: -4px;">
        <div style="display: inline-block">
