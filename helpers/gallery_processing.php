...
include 'dirList.php';
$mainFolder    = $photosDir;   // folder where your albums are located - relative to root
$albumsPerPage = '12';       // number of albums per page
$itemsPerPage  = '12';       // number of images per page
$thumb_width   = '230';      // width of thumbnails
   ...
   if( count($albums) == 0 ) {
      ...
      echo 'There are currently no albums.';
        ...
        if(isset($_GET['p'])) {
	     ...
	     echo '<div class="titlebar"> <div class="float-left"><span class="title">Photo Gallery</span> - Albums</div> <div class="float-right">'.count($albums).' albums</div> </div>';
